# Configurando Client Credentials Flow no Keycloack
...
![Novo Client - Configurando Client Credentials Flow](imagens/keycloak-new-client-client-credentials-flow.png)
